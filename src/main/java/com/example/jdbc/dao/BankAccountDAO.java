...
import com.example.jdbc.exception.BankTransactionException;
import com.example.jdbc.mapper.BankAccountMapper;
...
public class BankAccountDAO extends JdbcDaoSupport {
	...
	@Transactional(propagation = Propagation.MANDATORY)// @formatter:off
	...
	// Do not catch BankTransaction in this method.
